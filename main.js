...
let items = [
  ...
  {
    item: 'Spanish bread with kapeng barako',
    cost: 3.99,
    quantity: 0,
    total: 0,
  ...
  {
    item: ' Sweet potato fries and Grilled Steak ',
    cost: 11.99,
    quantity: 0,
    total: 0,
